...
int yoloV3()
{
	...
	//coco数据集的名称文件，80类
	string classesFile = "E:\\课程\\大二下\\数字图像处理\\coco.names";
	//yolov3网络模型文件
	String yolov3_model = "E:\\课程\\大二下\\数字图像处理\\yolov3.cfg";
	//权重
	String weights = "E:\\课程\\大二下\\数字图像处理\\yolov3.weights";
...
int openpose()
{
	...
	//读入网络模型和权重文件
	String modelTxt = "E:\\课程\\大二下\\数字图像处理\\openpose_pose_coco.prototxt";
	String modelBin = "E:\\课程\\大二下\\数字图像处理\\openpose_caffe_models\\caffe_models\\pose\\coco\\pose_iter_440000.caffemodel";
